...
function VideoCard({ card, handleRemoveStatus, insideCategory }) {
    ...
    <>
      ...
      <div>
        ...
        <Card className='shadow' draggable onDragStart={e => dragStarted(e, card?.id)}>
          <Card.Img variant="top" onClick={handleShow} height={'180px'} src={card?.thumbnail} />
          <Card.Body>
            <Card.Title>
        ...
        <Modal show={show} onHide={handleClose}>
          ...
          <Modal.Body>
            ...
            {/* autoplay      =>   link?autoplay=1 */}

            <iframe width="100%" height="300" src={`${card?.url}?autoplay=1`} title="Neela Nilave - Video Song | RDX | Kapil Kapilan | Sam CS | Shane Nigam,Antony Varghese,Neeraj Madhav" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
